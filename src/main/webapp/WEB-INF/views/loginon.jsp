                        ...
                        <section class="main-content">
                           ...
                           <div class="tabs">
                              <button class="tab-button active"
                                 onclick="showTab('generation')">발전량</button>
                              ...
                              <div class="modal-content">
                                 ...
                                 <form id="plant-form" action="plantRegister" method="post">
                                    ...
                                    <label for="plant-postcode">우편번호</label> <input type="text"
                                       id="plant-postcode" name="zipCode" required><br>
                                    <br> <label for="plant-address">발전소 주소</label> <input
                                       type="text" id="plant-address" name="pAddress" required><br>
                                    <br> <label for="plant-detail">상세주소</label> <input
                                       type="text" id="plant-detail" name="pDetail" required><br>
                                    <br> <input name="memId" value="${user.memId}"
                                       type="hidden">
